package com.mufeng.baselibrary.widget
...
import com.mufeng.baselibrary.databinding.KtxTitlebarBinding
import com.mufeng.baselibrary.utils.*
...
class TitleBar @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private lateinit var binding: KtxTitlebarBinding
    ...
    init {
        ...
        ta.recycle()
        val root = inflate(context, R.layout.ktx_titlebar, this)
        binding = KtxTitlebarBinding.bind(root)
        clipToOutline = true
        applyAttr()
        applySelf()
        initClick()
